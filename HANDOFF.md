...
**页面内文档入口（重点待办）**
- [ ] **在页面内加入「使用指南」入口**（如顶部 ⓘ 或 ❓ 按钮），点开以弹窗/抽屉形式展示 `USAGE.md` 的内容
- [ ] 首次访问时弹出简短的**新手引导**（3-4 步高亮提示：切换引擎、拍照、AI提问、添加到主屏幕）
- [ ] AI 面板里加入「怎么用」小提示，降低首次使用门槛
- [ ] 页脚增加「使用指南 / 隐私说明」链接
...
- [ ] USAGE.md 增加"更新日志"章节，让用户知道每次新增了什么
- [ ] USAGE.md 增加"进阶技巧"章节（如 AI 提问的话术模板、识图引擎组合用法）
- [ ] 把 USAGE.md 做成页面可渲染的格式，供页面内指南入口直接读取（见 A 组）
- [ ] HANDOFF.md 补充架构图（数据流：用户→识图引擎/AI→结果）
- [ ] 两份文档补充"版本号"与"最后更新日期"，便于追踪
